...
void FlashTask(void *argument)
{
  ...
  W25Q32_PageProgram(0x000000, (const uint8_t *)"Hello, W32q76 Flash!", 20);
  /* Infinite loop */
  for(;;)
  {
    uint8_t readBuffer[20];
    W25Q32_ReadData(0x000000, readBuffer, 20);
    HAL_UART_Transmit(&huart1, readBuffer, 20, HAL_MAX_DELAY);
    osDelay(500);
  }
